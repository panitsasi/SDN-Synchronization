...
config.qExcluder = False
config.NNrestarter = False
#config.controlledShut = True
config.alternator = True

config.environment = sdnSync_LB(config.alternator, numStates=7, numActions=7, budget=2, place_budget=3, numSteps = 2100)
...
config.hyperparameters = {
    "DQN_Agents": {
        ...
        "buffer_size": 40000,
        "epsilon": 1.0,
        "epsilon_decay_rate_denominator": 10,  #20 was before
        "discount_rate": 0.4,  #0.01,  #0.99,
        "tau": 0.01,


        "update_every_n_steps": 1,
        "linear_hidden_units": [40],
