...
# network_state = NetworkState_LB_C(state_size=5, num_controllers=1)
# network_state.visualize_graph()
# G = network_state.fullG
...
# nx.draw_networkx_edge_labels(G, pos, edge_labels=edge_weights, font_size=12)
# edge_weights = nx.get_edge_attributes(G, 'weight')
