...
from agents.customNets import changeNN
...
class Base_Agent(object):
    ...
    def __init__(self, config):
        ...
        self.rand_game_full_episode_scores = []
        self.robin_game_full_episode_scores = []
    ...
    def get_score_required_to_win(self):
        ...
        if self.environment_title == "sdnSync": return float("inf")
        if self.environment_title == "sdnSyncSP": return float("inf")
        if self.environment_title == "sdnSyncLB": return float("inf")
    ...
    def reset_game(self):
        ...
        self.networkChange = False
        
        self.rand_total_episode_score_so_far = 0
        self.robin_total_episode_score_so_far = 0
    ...
    def run_n_episodes(self, num_episodes=None, show_whether_achieved_goal=True, save_and_print_results=True):
        ...
        return self.game_full_episode_scores, self.rolling_results, time_taken, self.rand_game_full_episode_scores, self.robin_game_full_episode_scores, self.downCount, self.UpCount, self.newCount
    ...
    def conduct_action(self, action):
        ...
        self.next_state, self.reward, self.done, _, self.randReward, self.robinReward, self.downCount, self.UpCount, self.newCount, self.networkChange = self.environment.step(action)
        self.total_episode_score_so_far += self.reward
        self.rand_total_episode_score_so_far += self.randReward
        self.robin_total_episode_score_so_far += self.robinReward
    ...
    def save_and_print_result(self):
        ...
        self.save_result()
        self.print_other_method_result()
    ...
    def save_result(self):
        ...
        self.rand_game_full_episode_scores.append(self.rand_total_episode_score_so_far)
        self.robin_game_full_episode_scores.append(self.robin_total_episode_score_so_far)
    ...
    def print_other_method_result(self):
        text = """""\r Episode {0}, randomization Score: {1: .2f}, robin method score: {2: .2f}"""
        print(text.format(len(self.game_full_episode_scores), self.rand_game_full_episode_scores[-1],self.robin_game_full_episode_scores[-1]))   
    ...
    def create_NN(self, input_dim, output_dim, key_to_use=None, override_seed=None, hyperparameters=None):
        ...
        return changeNN(input_dim=input_dim, output_dim=output_dim, 
